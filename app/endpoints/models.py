...
class Endpoint(models.Model):
    ...
    Attributes:
        name: The name of the endpoint, it will used in API URL,
...
class MLAlgorithmStatus(models.Model):
    '''
    The MLAlgorithmStatus represent status of the MLAgorithm which can change during the time
...
class MLRequest(models.Model):
    ...
    Attributes:
        input_data: The input data to ML algorthm in Json format
