...
from app.ml.income_classifier.random_forest import RandomForestClassifier
...
class MLTests(TestCase):
    ...
    #                             algorithm_verison, algorithm_owner, algorithm_description, 
    #                             algorithm_code)
